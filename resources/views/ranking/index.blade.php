    ...
    <div class="col-lg-12">
      ...
      <div class="card mb-4 shadow">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h2 class="h4 font-weight-bold text-primary m-0">Hasil Ranking Metode Smart</h2>
        </div>
        <div class="card-body">
              ...
              <tbody>
                @foreach ($hasil_penilaian as $penilaian)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('hasil-penilaian.show', $penilaian->user_id) }}" class="btn btn-primary btn-sm">
